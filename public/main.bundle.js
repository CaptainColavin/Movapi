...
module.exports = "<h2 class=\"page-header\">DashBoard/Tableau de bord</h2>\n<p>Bienvenue dans votre centre de contrôle</p>"
...
var RegisterComponent = (function () {
    function RegisterComponent(validateService, flashMessage, authService //,
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        if (!this.validateService.validateRegister(user)) {
            //console.log("please send in all fields");
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            if (data.success) {
                _this.flashMessage.show('User registered, please log in', { cssClass: 'alert-success', timeout: 3000 });
                //this.router.navigate(['/login']);
            }
            else {
                _this.flashMessage.show('User NOT registered', { cssClass: 'alert-danger', timeout: 3000 });
...
RegisterComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__services_validate_service__["a" /* ValidateService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__services_validate_service__["a" /* ValidateService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_3_angular2_flash_messages__["FlashMessagesService"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3_angular2_flash_messages__["FlashMessagesService"]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__services_auth_service__["a" /* AuthService */] //,
         !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services_auth_service__["a" /* AuthService */] //,
        ) === "function" && _c || Object])
], RegisterComponent);
